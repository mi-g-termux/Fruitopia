...
`This will permanently delete the invoice record of Order #${o.orderNumber} for ${o.customerName}. This action is irreversible.`,
 ...
 <div className="bg-slate-50 border border-slate-200 p-4 rounded-xl"> <h4 className="text-xs font-bold uppercase text-slate-700 mb-3">Add Custom Promo Code</h4> <form onSubmit={handleCreateCoupon} className="grid grid-cols-1 sm:grid-cols-4 gap-3 items-end"> <div> <label className="block text-[9px] font-bold uppercase text-slate-500 mb-1">Coupon Code *</label> <input
 type="text"
 required
 value={coupCode}
...
"{r.comment}"
 ...
 <p className="text-[9px] text-[#ff5c35] font-bold uppercase mt-1"> Linked listing item: {mappedItem.image} {mappedItem.name}
 </p> )}
